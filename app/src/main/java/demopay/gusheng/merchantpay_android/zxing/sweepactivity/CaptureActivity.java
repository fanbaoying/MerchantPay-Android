package demopay.gusheng.merchantpay_android.zxing.sweepactivity;
...
import demopay.gusheng.merchantpay_android.activity.SweepActivity;
import demopay.gusheng.merchantpay_android.util.Constant;
import demopay.gusheng.merchantpay_android.util.UriUtil;
...
import demopay.gusheng.merchantpay_android.zxing.camera.CameraManager;
import com.google.zxing.common.HybridBinarizer;
import demopay.gusheng.merchantpay_android.zxing.decoding.CaptureActivityHandler;
import demopay.gusheng.merchantpay_android.zxing.decoding.InactivityTimer;
import demopay.gusheng.merchantpay_android.zxing.decoding.RGBLuminanceSource;
import com.google.zxing.qrcode.QRCodeReader;
import demopay.gusheng.merchantpay_android.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        merchantPayMoney = (TextView) findViewById(R.id.merchant_payMoney);
        ...
        changebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 生成二维码
                Intent intent = new Intent(CaptureActivity.this, SweepActivity.class);

                intent.putExtra("payMoney", data);
